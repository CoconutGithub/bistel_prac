<<<<<<< HEAD
# Bistelligence Practice Projects
...
```
cd existing_repo
git remote add origin http://git.bistelligence.ai/cec-developers/bistelligence-portal.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.bistelligence.ai/cec-developers/bistelligence-portal/-/settings/integrations)
