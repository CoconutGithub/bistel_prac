...
class ContextAutoencoder(nn.Module):
    def __init__(self, img_size=128, patch_size=16, in_chans=3, 
        ...
        # --------------------------------------------------------------------------
        # 1. MAE Encoder (ViT Backbone)
        # --------------------------------------------------------------------------
        # timm의 ViT를 활용하되, MAE 스타일에 맞게 일부 수정
    ...
    def initialize_weights(self):
        # initialization
        # (Sin-Cos pos embed init code would go here, simplified to random for now or skipped)
...
def cae_base_patch16_128(**kwargs):
