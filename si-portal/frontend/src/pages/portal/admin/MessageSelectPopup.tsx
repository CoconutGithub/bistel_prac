...
const RoleRegistPopup: React.FC<MessageSelectPopupProps> = ({ show, onClose, selectMessage }) => {
                ...
                <Form>
                    <Form.Group as={Row} className="mb-3 d-flex align-items-center">
                        <Form.Label column sm={2} className="text-end">
                            <strong>{comAPIContext.$msg("label", "MSG TYPE", "MSG TYPE")}</strong>
                        </Form.Label>
                        <Col sm={3}>
                        ...
                        <Form.Label column sm={2} className="text-end">
                            <strong>{comAPIContext.$msg("label", "MESSAGE NAME", "MESSAGE NAME")}</strong>
                        </Form.Label>
                        <Col sm={3} className="d-flex align-items-center">
                            ...
                            />
                            <ComButton variant="primary" onClick={handleSearch} className="ms-2">
