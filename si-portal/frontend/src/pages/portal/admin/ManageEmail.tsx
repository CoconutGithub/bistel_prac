...
// 컬럼 정의
const columnDefs = [
  { field: 'sendUser', headerName: '보낸사람', sortable: true, filter: true, editable: false, width: 150 },
  { field: 'sendReciver', headerName: '받는사람', sortable: true, filter: true, editable: true, width: 150 },
  ...
  { field: 'readYn', headerName: '읽음여부', sortable: true, filter: true, editable: true, width: 150, cellEditor: 'agSelectCellEditor', cellEditorParams: { values: ['Y', 'N'] } },
  { field: "creationTime", headerName: "보낸시간", sortable: true, filter: true },
];
